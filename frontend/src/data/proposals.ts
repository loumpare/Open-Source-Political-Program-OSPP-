...
Dokumentierte Ergebnisse (MTI Singapur 2022, OECD Skills Outlook 2019): Inanspruchnahme: 640.000 Singapurer nutzten das Guthaben bis 2021 (24 % der Berechtigten). Wiederbeschäftigung: Arbeitnehmer, die Mid-Career-Schulungen abschlossen: +12 % Lohnprämie (MOM 2019). Produktivität: Arbeitsproduktivitätswachstum +3,8 %/Jahr 2016–2019. Innovation: World Economic Forum Innovation Index: Singapur global auf Platz 8 (2020). PISA 2022: Singapur global an der Spitze in Mathematik, Naturwissenschaften und Lesen zum 15. Mal in Folge. Einschränkung: 76 % des Guthabens von Hochschulabsolventen genutzt (regressiver Uptake); Handarbeiter unterrepräsentiert.`,
  ...
  // ── 12 NOUVELLES PROPOSITIONS HISTORIQUES ──────────────────────────────────

  {
    id: 'SOC-GLOBAL-HIST-002',
    country: 'Global',
    countryFlag: '🌍',
    domain: 'social',
    title: 'GiveDirectly UBI — Kenya Long-Term Study 2016',
    titleFr: 'Revenu universel GiveDirectly — Étude Kenya 2016',
    titleDe: 'GiveDirectly BGE — Kenia-Langzeitstudie 2016',
    summary: "World's largest and longest RCT on UBI: 23,000 individuals in 295 Kenyan villages receive monthly cash transfers unconditionally (≈$22/month, ~75% of local consumption baseline) for 12 years. Run by GiveDirectly with $30M budget.",
    summaryFr: "La plus grande et longue étude RCT sur le revenu universel : 23 000 individus dans 295 villages kényans reçoivent des transferts monétaires inconditionnels (~22 $/mois, ~75 % du niveau de consommation local) pendant 12 ans. Budget : 30 M$.",
    summaryDe: 'Weltgrößte und längste RCT-Studie zum Grundeinkommen: 23.000 Personen in 295 kenianischen Dörfern erhalten 12 Jahre lang bedingungslose Geldtransfers (~22 $/Monat). Budget: 30 Mio. $.',
    content: `GiveDirectly launched the world's largest and longest UBI study in Kenya in 2016. The study covers 295 villages: long-term villages (12-year transfers), short-term villages (2-year lump sum), and control villages (no transfers). Total budget: $30M.\n\nKey 2023 results: hunger rates fell from 68% to 57% in long-term recipient villages. Recipients invested transfers rather than consuming idly — livestock ownership increased, small businesses were started. Both lump-sum and long-term UBI proved effective: lump sums enabled large investments (roof improvements, business capital), while the 12-year guarantee encouraged savings and risk-taking.\n\nEconomic spillovers were documented in control villages within treatment areas, suggesting positive multiplier effects. No evidence of inflation in treatment villages. Recipients were not more likely to be idle — time use surveys showed increased productive activity. Asset accumulation was strongest in long-term recipients.\n\nSources: GiveDirectly 2023 annual report, Egger et al. (2022) Science: 'General Equilibrium Effects of Cash Transfers.'`,
    contentFr: `GiveDirectly a lancé la plus grande étude RCT sur le revenu universel au Kenya en 2016. L'étude couvre 295 villages : villages bénéficiaires à long terme (transferts sur 12 ans), villages bénéficiaires à court terme (somme forfaitaire sur 2 ans) et villages témoins. Budget total : 30 M$.\n\nRésultats clés 2023 : le taux de faim est passé de 68 % à 57 % dans les villages bénéficiaires à long terme. Les bénéficiaires ont investi les transferts plutôt que de les consommer passivement — la possession de bétail a augmenté et de petites entreprises ont été créées. Les deux formes de RUB se sont avérées efficaces : les versements forfaitaires ont permis des investissements importants (toits, capital commercial), tandis que la garantie sur 12 ans a favorisé l'épargne et la prise de risque.\n\nDes effets d'entraînement économiques ont été documentés dans les villages témoins des zones de traitement, suggérant des effets multiplicateurs positifs. Aucune inflation n'a été observée. Les bénéficiaires n'étaient pas plus enclins à l'oisiveté — les enquêtes sur l'utilisation du temps montraient une activité productive accrue.`,
    contentDe: `GiveDirectly startete 2016 die weltweit größte und längste BGE-Studie in Kenia. Die Studie umfasst 295 Dörfer: Langzeit-Begünstigte (12-Jahres-Transfers), Kurzzeit-Begünstigte (2-Jahres-Einmalzahlung) und Kontrolldörfer. Gesamtbudget: 30 Mio. $.\n\nZentrale Ergebnisse 2023: Die Hungerrate sank in Langzeit-Begünstigtendörfern von 68 % auf 57 %. Empfänger investierten die Transfers statt sie untätig zu konsumieren — Viehbesitz nahm zu, Kleinunternehmen wurden gegründet. Sowohl Einmalzahlung als auch Langzeit-BGE erwiesen sich als wirksam.\n\nEkonomische Ausstrahlungseffekte wurden in Kontrolldörfern innerhalb von Behandlungsgebieten dokumentiert, was auf positive Multiplikatoreffekte hindeutet. Keine Inflation in Behandlungsdörfern. Empfänger zeigten keine erhöhte Untätigkeit — Zeitnutzungserhebungen belegten gesteigerte produktive Aktivität.`,
    status: 'adopted',
    author: 'historical',
    date: '2016-01-01',
    impactStatement: 'Redefines the global UBI evidence base: 23,000 participants, 12-year horizon, RCT design.',
    populationAffected: '23,000 Kenyan villagers (295 villages)',
    estimatedCost: '$30M total; ~$22/month per recipient',
    sources: [
      { label: 'GiveDirectly — 2023 UBI Results Annual Report', year: 2023 },
      { label: 'Egger et al. — General Equilibrium Effects of Cash Transfers: Experimental Evidence from Kenya, Science', year: 2022 },
      { label: 'Haushofer & Shapiro — The Long-Term Impact of Unconditional Cash Transfers: Experimental Evidence from Kenya, QJE', year: 2022 },
    ],
    tags: ['UBI', 'basic income', 'Kenya', 'RCT', 'GiveDirectly', 'poverty', 'cash transfers', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2016–2023 (étude en cours)',
      country_context: 'Kenya rural, 23 000 participants, RCT randomisé',
      gdp_impact: 'Multiplicateur local >2 : chaque $1 transféré génère $2.60 de PIB local (Egger 2022)',
      employment_impact: "Activité productive ++; création de micro-entreprises; aucune oisiveté mesurée",
      inequality_impact: "Faim −16 pp; accumulation d'actifs ++; effets positifs pour les non-bénéficiaires via spillovers",
      fiscal_impact: 'Coût $30M pour 23 000 personnes; 0 coût fiscal gouvernemental (financement privé)',
      key_finding: "La plus grande étude RCT mondiale sur l'UBI confirme : réduction de la faim, hausse de l'investissement, effet multiplicateur positif, aucun désincitation au travail.",
      sources: ['GiveDirectly Annual Report 2023', 'Egger et al. Science 2022'],
    },
  },

  {
    ...
    countryFlag: '🇺🇸',
    domain: 'economy',
    title: 'Stockton SEED — City Basic Income Pilot 2019',
    titleFr: 'SEED Stockton — Pilote revenu de base municipal 2019',
    titleDe: 'Stockton SEED — Städtisches Grundeinkommenspilotprojekt 2019',
    summary: '125 Stockton residents randomly selected from zip codes at or below the city\'s median household income received $500/month unconditionally for 24 months (Feb 2019–Jan 2021). Rigorous RCT with matched control group of 200 residents.',
    summaryFr: '125 résidents de Stockton sélectionnés aléatoirement parmi les codes postaux à revenu médian inférieur ont reçu 500 $/mois sans conditions pendant 24 mois. Étude RCT rigoureuse avec groupe témoin de 200 personnes.',
    summaryDe: '125 zufällig ausgewählte Stockton-Einwohner aus einkommensschwachen Stadtteilen erhielten 24 Monate lang bedingungslos 500 $/Monat. Rigorose RCT mit Kontrollgruppe von 200 Personen.',
    content: `The Stockton Economic Empowerment Demonstration (SEED), launched February 2019, was the first US mayor-led guaranteed income pilot (Mayor Michael Tubbs). 125 residents below median income received $500/month for 24 months; 200 matched controls received nothing.\n\nKey results (Mayors for a Guaranteed Income, 2021): Full-time employment rose from 28% to 40% for recipients vs 5% increase in control group. Income volatility: controls experienced 1.5× more volatility. Mental health: significant reductions in depression and anxiety scores. Food security improved. Recipients spent primarily on food (35%), retail (20%), utilities (12%) — not luxuries or vices.\n\nThe pilot inspired 100+ cities to launch similar programs. Critics noted the small sample size (125) and 24-month duration limit generalizability. No tax mechanism was tested (private funding from Economic Security Project). Cost if scaled to all Stockton residents: ~$300M/year.`,
    contentFr: `Le Stockton Economic Empowerment Demonstration (SEED), lancé en février 2019, a été le premier pilote de revenu garanti dirigé par un maire américain (Michael Tubbs). 125 résidents sous le revenu médian recevaient 500 $/mois pendant 24 mois ; 200 témoins ne recevaient rien.\n\nRésultats clés (Mayors for a Guaranteed Income, 2021) : L'emploi à temps plein est passé de 28 % à 40 % chez les bénéficiaires contre 5 % d'augmentation dans le groupe témoin. Volatilité des revenus : les témoins ont subi 1,5× plus de volatilité. Santé mentale : réductions significatives de la dépression et de l'anxiété. Les dépenses portaient principalement sur l'alimentation (35 %), le commerce (20 %), les services publics (12 %).\n\nLe pilote a inspiré plus de 100 villes à lancer des programmes similaires. Les critiques soulignent la petite taille de l'échantillon (125 personnes) et la durée limitée de 24 mois.`,
    contentDe: `Das Stockton Economic Empowerment Demonstration (SEED), gestartet im Februar 2019, war das erste von einem US-Bürgermeister geleitete Garantieeinkommen-Pilotprojekt (Bürgermeister Michael Tubbs). 125 Einwohner mit unterdurchschnittlichem Einkommen erhielten 24 Monate lang 500 $/Monat; 200 Kontrollpersonen erhielten nichts.\n\nZentrale Ergebnisse: Vollzeitbeschäftigung stieg bei Begünstigten von 28 % auf 40 % vs. 5 % Anstieg in der Kontrollgruppe. Einkommensvolatilität: Kontrollpersonen erlebten 1,5× mehr Volatilität. Psychische Gesundheit: signifikante Reduktionen von Depression und Angst. Ausgaben hauptsächlich für Lebensmittel (35 %), Einzelhandel (20 %), Versorgungsleistungen (12 %).`,
    status: 'adopted',
    author: 'historical',
    date: '2019-02-01',
    impactStatement: 'Model for 100+ US and global city basic income programs.',
    populationAffected: '125 recipients; model for millions if scaled',
    estimatedCost: '$500/month × 125 × 24 = $1.5M (private funding)',
    sources: [
      { label: "Mayors for a Guaranteed Income — SEED: Stockton Economic Empowerment Demonstration Final Report", year: 2021 },
      { label: "West, Stophel & Weller — Preliminary Analysis: SEED's First Year", year: 2021 },
    ],
    tags: ['basic income', 'UBI', 'Stockton', 'USA', 'guaranteed income', 'employment', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2019–2021',
      country_context: 'Stockton CA, ville 310 000 hab., revenu médian $46 033',
      gdp_impact: 'Non mesurable à l\'échelle ville; multiplicateur local estimé positif',
      employment_impact: 'Emploi temps plein +12 pp (28→40%) vs +5 pp groupe témoin',
      inequality_impact: 'Volatilité revenus −33% vs contrôle; santé mentale ++; sécurité alimentaire ++',
      fiscal_impact: 'Coût $1.5M (financement privé); aucune taxe locale levée',
      key_finding: "Hausse significative de l'emploi à temps plein et réduction de la précarité; premier pilote à démontrer que le revenu garanti augmente — pas réduit — l'emploi aux USA.",
      sources: ['MGI SEED Final Report 2021'],
    },
  },

  {
    ...
    countryFlag: '🇬🇧',
    domain: 'governance',
    title: 'Brexit — UK Withdrawal from the European Union 2016',
    titleFr: "Brexit — Retrait du Royaume-Uni de l'Union européenne 2016",
    titleDe: 'Brexit — Austritt des Vereinigten Königreichs aus der EU 2016',
    summary: 'Following the June 2016 referendum (52% Leave), the UK formally left the EU on 31 January 2020 and the Single Market on 31 December 2020. The most studied economic shock of the decade, with documented trade, investment, GDP, and productivity consequences.',
    summaryFr: "Après le référendum de juin 2016 (52 % Leave), le Royaume-Uni a quitté l'UE le 31 janvier 2020 et le marché unique le 31 décembre 2020. Le choc économique le plus étudié de la décennie, avec des conséquences documentées sur les échanges, l'investissement, le PIB et la productivité.",
    summaryDe: 'Nach dem Referendum vom Juni 2016 (52 % für den Austritt) verließ das Vereinigte Königreich die EU am 31. Januar 2020 und den Binnenmarkt am 31. Dezember 2020. Der meistuntersuchte Wirtschaftsschock des Jahrzehnts, mit dokumentierten Auswirkungen auf Handel, Investitionen, BIP und Produktivität.',
    content: `The 2016 Brexit referendum triggered an immediate currency shock: the pound fell 10% against the euro. The actual withdrawal from the EU (Jan 2020) and the Single Market (Dec 2020) created new barriers to trade in goods and services.\n\nDocumented GDP consequences (Bloomberg Economics, Goldman Sachs, NBER 2025): UK GDP is estimated to be 4–6% lower than it would have been without Brexit. Goldman Sachs (2024) estimated Brexit had sliced 5% off UK economic growth. The OBR projects Brexit reduces UK trade intensity by 15% relative to a counterfactual. UK goods trade underperformed other advanced economies by ~15% since the Leave vote.\n\nInvestment: business investment fell 10–18% below pre-referendum trends. Employment: Cambridge Econometrics estimates 2 million fewer jobs nationally; London: 300,000 fewer jobs. Immigration: EU net migration collapsed from +180,000/year to near zero (2020), creating acute labour shortages in healthcare, agriculture, and hospitality. Financial services: €1.5T in assets relocated from London to EU cities.\n\nRed lines and trade-offs: Northern Ireland Protocol (later Windsor Framework) created de facto regulatory borders within the UK itself. GDP cost: £100–200B/year in foregone output (Bloomberg 2025).`,
    contentFr: `Le référendum Brexit de 2016 a déclenché un choc immédiat sur la livre sterling, qui a chuté de 10 % face à l'euro. Le retrait effectif de l'UE (jan. 2020) et du marché unique (déc. 2020) a créé de nouvelles barrières commerciales.\n\nConséquences sur le PIB (Bloomberg Economics, Goldman Sachs, NBER 2025) : le PIB du Royaume-Uni est estimé 4 à 6 % inférieur à ce qu'il aurait été sans le Brexit. Goldman Sachs (2024) estime que le Brexit a amputé 5 % de la croissance économique britannique. L'OBR projette que le Brexit réduit l'intensité commerciale du Royaume-Uni de 15 % par rapport à un scénario contrefactuel.\n\nInvestissement : l'investissement des entreprises a chuté de 10 à 18 % en dessous des tendances pré-référendum. Emploi : Cambridge Econometrics estime 2 millions d'emplois de moins à l'échelle nationale ; Londres : 300 000 emplois de moins. Immigration : la migration nette de l'UE s'est effondrée de +180 000/an à quasi zéro (2020), créant des pénuries aiguës dans la santé, l'agriculture et l'hôtellerie. Services financiers : 1 500 Md€ d'actifs relocalisés de Londres vers des villes européennes.`,
    contentDe: `Das Brexit-Referendum 2016 löste einen sofortigen Währungsschock aus: Das Pfund fiel um 10 % gegenüber dem Euro. Der eigentliche Austritt aus der EU (Jan. 2020) und dem Binnenmarkt (Dez. 2020) schuf neue Handelsbarrieren.\n\nDokumentierte BIP-Folgen: Laut Bloomberg Economics, Goldman Sachs und NBER (2025) ist das britische BIP 4–6 % niedriger als ohne Brexit. Goldman Sachs (2024) schätzt, dass Brexit 5 % des britischen Wirtschaftswachstums gekostet hat. Das OBR prognostiziert eine Reduktion der Handelsintensität um 15 %.\n\nInvestitionen fielen 10–18 % unter vorherige Trends. Cambridge Econometrics schätzt 2 Millionen weniger Arbeitsplätze landesweit. EU-Nettomigration kollabierte von +180.000/Jahr auf nahe null (2020), was zu akuten Arbeitskräftemangel in Gesundheit, Landwirtschaft und Gastgewerbe führte. Finanzdienstleistungen: €1,5 Bio. an Vermögenswerten verlagerten sich von London in EU-Städte.`,
    status: 'adopted',
    author: 'historical',
    date: '2016-06-23',
    impactStatement: 'Largest unilateral economic self-shock by a major economy in modern history.',
    populationAffected: '67 million UK residents; 450M EU citizens affected by reduced trade',
    estimatedCost: 'GDP cost £100–200B/year (Bloomberg 2025); trade reduction −15%; 2M fewer jobs',
    sources: [
      { label: 'Goldman Sachs — Brexit Has Sliced 5% Off UK Economic Growth', year: 2024 },
      { label: 'NBER w34459 — Bloom et al.: The Economic Impact of Brexit', year: 2025 },
      { label: 'OBR — How Are Our Brexit Trade Forecast Assumptions Performing?', year: 2024 },
      { label: 'CEPR VoxEU — The Impact of Brexit on the UK Economy: Reviewing the Evidence', year: 2023 },
    ],
    tags: ['Brexit', 'UK', 'EU', 'trade', 'GDP', 'sovereignty', 'immigration', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2016–2024',
      country_context: 'Royaume-Uni, PIB $3.1T, 67M habitants, 2ème partenaire commercial mondial',
      gdp_impact: 'PIB 4–6% inférieur vs contrefactuel; −£100–200B/an (Bloomberg 2025)',
      employment_impact: '−2M emplois (Cambridge Econometrics); pénuries sectorielles santé/agri',
      inequality_impact: 'Régions industrielles (Midlands, Nord) plus touchées; Londres −300 000 emplois',
      fiscal_impact: 'Commerce biens −15% vs pairs; investissements entreprises −10 à 18%',
      key_finding: "Le choc économique auto-infligé le plus documenté de l'histoire récente: coût structurel persistant et croissant, sans bénéfice macroéconomique mesurable identifié à ce jour.",
      sources: ['Goldman Sachs 2024', 'NBER Bloom 2025', 'OBR 2024'],
    },
  },

  {
    ...
    countryFlag: '🇺🇸',
    domain: 'economy',
    title: 'US-China Trade War — Trump Tariffs 2018',
    titleFr: 'Guerre commerciale USA-Chine — Tarifs douaniers Trump 2018',
    titleDe: 'US-China Handelskrieg — Trump-Zölle 2018',
    summary: 'From July 2018, the US imposed tariffs of 25% on $250B of Chinese goods, with China retaliating with tariffs on $110B of US goods. The most studied trade war in modern economic history, with documented effects on prices, jobs, investment, and agricultural exports.',
    summaryFr: "À partir de juillet 2018, les États-Unis ont imposé des droits de douane de 25 % sur 250 Mds$ de marchandises chinoises, la Chine ripostant avec des tarifs sur 110 Mds$ de biens américains. La guerre commerciale la plus étudiée de l'histoire économique moderne.",
    summaryDe: 'Ab Juli 2018 erhob die USA Zölle von 25 % auf chinesische Waren im Wert von 250 Mrd. $, worauf China mit Zöllen auf US-Waren im Wert von 110 Mrd. $ reagierte. Der meistuntersuchte Handelskrieg der modernen Wirtschaftsgeschichte.',
    content: `The US-China trade war began in January 2018 with tariffs on solar panels and washing machines, escalating through 2018-2019 to cover $250B of Chinese imports at 25%. China retaliated on $110B of US goods, targeting agriculture (soybeans, pork, dairy).\n\nDocumented consequences (NBER, Moody's Analytics, Oxford Economics, Federal Reserve): GDP loss: −0.3% to −0.5% US GDP (Oxford Economics estimated 245,000 jobs lost). Consumer prices: US consumers bore ~100% of tariff costs — import prices rose by the full tariff amount, with no evidence of Chinese export prices falling. Agricultural damage: US lost $20B in annual farm exports to China; soybean exports to China fell 75% in 2018. Stock market: US companies lost $1.7T in stock value (FRBNY/Columbia University).\n\nIndustrial impact: while some protected industries (steel, aluminium) saw employment gains, these were outweighed by losses in downstream manufacturing sectors paying higher input costs. Manufacturing employment had a net negative response (Federal Reserve). Phase One deal (Jan 2020) required China to buy $200B of additional US goods — China met ~58% of the target.\n\nSources: Fajgelbaum & Khandelwal (2022) 'The Economic Impacts of the US-China Trade War' NBER; Amiti, Redding & Weinstein (2019) AER.`,
    contentFr: `La guerre commerciale USA-Chine a débuté en janvier 2018 avec des tarifs sur les panneaux solaires et les machines à laver, pour s'étendre en 2018-2019 à 250 Mds$ d'importations chinoises à 25 %. La Chine a riposté sur 110 Mds$ de biens américains, ciblant l'agriculture.\n\nConséquences documentées (NBER, Moody's, Oxford Economics, Fed) : Perte de PIB : −0,3 % à −0,5 % (Oxford Economics estime 245 000 emplois perdus). Prix à la consommation : les consommateurs américains ont supporté ~100 % du coût des tarifs — sans baisse des prix d'exportation chinois. Dommages agricoles : les États-Unis ont perdu 20 Mds$/an d'exportations agricoles vers la Chine ; les exportations de soja vers la Chine ont chuté de 75 % en 2018. Marchés boursiers : les entreprises américaines ont perdu 1 700 Mds$ de capitalisation.\n\nL'accord de phase 1 (jan. 2020) exigeait que la Chine achète 200 Mds$ supplémentaires de biens américains — elle n'a atteint que 58 % de l'objectif.`,
    contentDe: `Der US-China-Handelskrieg begann im Januar 2018 mit Zöllen auf Solarpanele und Waschmaschinen und weitete sich 2018–2019 auf chinesische Importe im Wert von 250 Mrd. $ (25 % Zoll) aus. China vergalt mit Zöllen auf US-Waren im Wert von 110 Mrd. $, wobei die Landwirtschaft besonders getroffen wurde.\n\nDokumentierte Folgen: BIP-Verlust −0,3 bis −0,5 % (Oxford Economics schätzt 245.000 verlorene Arbeitsplätze). US-Verbraucher trugen ~100 % der Zollkosten. Landwirtschaft: USA verloren $20 Mrd./Jahr an Agrarexporten nach China; Sojaexporte nach China fielen 2018 um 75 %. Börsenwert: US-Unternehmen verloren $1,7 Bio.\n\nDas Phase-1-Abkommen (Jan. 2020) verpflichtete China, zusätzliche $200 Mrd. US-Güter zu kaufen — erreicht wurden ~58 % des Ziels.`,
    status: 'adopted',
    author: 'historical',
    date: '2018-07-06',
    impactStatement: 'Most studied trade war in modern economic history; $675 average household cost; 245,000 jobs lost.',
    populationAffected: '330M Americans; 1.4B Chinese; global supply chains',
    estimatedCost: '−$675/household (real income loss); $20B/year farm export losses',
    sources: [
      { label: 'Fajgelbaum & Khandelwal — The Economic Impacts of the US-China Trade War, NBER w29315', year: 2022 },
      { label: 'Oxford Economics — Trade War: Mapping the Impact on the US Economy', year: 2021 },
      { label: 'FRBNY & Columbia — US Companies Lost $1.7T from Trump China Tariffs', year: 2020 },
      { label: 'Brookings — More Pain Than Gain: How the US-China Trade War Hurt America', year: 2019 },
    ],
    tags: ['trade war', 'tariffs', 'Trump', 'China', 'USA', 'protectionism', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2018–2020',
      country_context: 'USA-Chine, PIB combiné $35T, commerce bilatéral $660B/an',
      gdp_impact: 'USA: −0.3 à −0.5% PIB réel; Chine: −0.3% PIB (IMF 2019)',
      employment_impact: '−245 000 emplois nets USA (Oxford Economics); acier +++ vs manufacturing downstream ---',
      inequality_impact: 'Consommateurs USA: −$675/foyer/an; agriculteurs USA: −$20B/an exportations',
      fiscal_impact: 'Recettes douanières $60B/an USA; supportées à 100% par importateurs/consommateurs américains',
      key_finding: "Les consommateurs américains ont supporté l'intégralité du coût des tarifs; perte nette emplois, PIB, et $1.7T de valeur boursière pour les entreprises US.",
      sources: ['Fajgelbaum & Khandelwal NBER 2022', 'Oxford Economics 2021', 'Brookings 2019'],
    },
  },

  {
    id: 'SOC-GLOBAL-HIST-003',
    country: 'Global',
    countryFlag: '🌍',
    domain: 'social',
    title: 'Brazil Bolsa Família — World\'s Largest CCT 2003–2024',
    titleFr: 'Brésil Bolsa Família — Plus grand programme de transfert conditionnel mondial 2003–2024',
    titleDe: 'Brasilien Bolsa Família — Weltgrößtes bedingtes Sozialtransfer-Programm 2003–2024',
    summary: 'Conditional cash transfer program reaching 20.4 million Brazilian families (R$600/month, ≈$120). Created in 2003 by Lula, discontinued by Bolsonaro (2019–2022), relaunched in March 2023. Under Lula\'s 2023 expansion: Brazil removed from the FAO Hunger Map, 8.7M Brazilians lifted above poverty line within one year.',
    summaryFr: "Programme de transfert monétaire conditionnel atteignant 20,4 millions de familles brésiliennes (600 R$/mois, ≈ 120 $). Créé par Lula en 2003, supprimé par Bolsonaro (2019-2022), relancé en mars 2023. Sous l'expansion Lula 2023 : le Brésil retiré de la carte de la faim de la FAO, 8,7 M de Brésiliens sortis de la pauvreté en un an.",
    summaryDe: 'Bedingtes Geldtransferprogramm für 20,4 Mio. brasilianische Familien (600 BRL/Monat, ≈ 120 $). 2003 von Lula gegründet, von Bolsonaro (2019–2022) eingestellt, im März 2023 wieder aufgelegt. Unter Lulas Expansion 2023: Brasilien von FAO-Hungerkarte gestrichen, 8,7 Mio. Brasilianer in einem Jahr aus der Armut gehoben.',
    content: `Bolsa Família, launched in 2003 by Lula da Silva's government, is one of the world's most studied and replicated conditional cash transfer programs. Conditions: families must keep children in school and maintain vaccination schedules. At peak under Lula I/II (2003-2010): covered 13 million families.\n\nUnder Bolsonaro (2019-2022), the program was renamed 'Auxílio Brasil' and partially dismantled, with benefits becoming irregular. As a result, Brazil re-entered the FAO Hunger Map in 2020 for the first time in years. Extreme poverty increased from 6.5% to 12.8% (2019-2022).\n\nLula III (2023): Program relaunched at R$600/month ($120) for 20.4 million families (budget: R$168B). Additional R$150 per child under 6, R$50 per child 7-18. Results within 12 months: 8.7 million Brazilians crossed the poverty line (10,875/day). Brazil removed from FAO Hunger Map. Poverty rate fell to 1.7%. However, 64 million Brazilians still experienced food insecurity in 2023 (27.6% of households).\n\nThe program's 20-year evidence base shows: school enrollment +6%, infant mortality −17%, child labor −14%, graduation rates significantly improved (World Bank 2015).`,
    contentFr: `Bolsa Família, lancé en 2003 par le gouvernement Lula, est l'un des programmes de transfert monétaire conditionnel les plus étudiés et répliqués au monde. Conditions : les familles doivent maintenir la scolarisation des enfants et les calendriers de vaccination.\n\nSous Bolsonaro (2019-2022), le programme a été rebaptisé « Auxílio Brasil » et partiellement démantelé, avec des prestations irrégulières. Résultat : le Brésil est réapparu sur la carte de la faim de la FAO en 2020. La pauvreté extrême est passée de 6,5 % à 12,8 % (2019-2022).\n\nLula III (2023) : Programme relancé à 600 R$/mois pour 20,4 millions de familles (budget : 168 Mds R$). Résultats en 12 mois : 8,7 millions de Brésiliens ont franchi le seuil de pauvreté (10 875/jour). Brésil retiré de la carte de la faim de la FAO. Taux de pauvreté tombé à 1,7 %. Toutefois, 64 millions de Brésiliens restaient en insécurité alimentaire en 2023 (27,6 % des ménages).`,
    contentDe: `Bolsa Família, 2003 von der Regierung Lula gestartet, ist eines der weltweit meistuntersuchten und kopierten bedingten Geldtransferprogramme. Bedingungen: Familien müssen Kinder in der Schule halten und Impfpläne einhalten.\n\nUnter Bolsonaro (2019–2022) wurde das Programm in 'Auxílio Brasil' umbenannt und teilweise demontiert, mit unregelmäßigen Leistungen. Folge: Brasilien erschien 2020 wieder auf der FAO-Hungerkarte. Extreme Armut stieg von 6,5 % auf 12,8 % (2019–2022).\n\nLula III (2023): Programm zu 600 BRL/Monat für 20,4 Mio. Familien wieder aufgelegt (Budget: 168 Mrd. BRL). Ergebnisse in 12 Monaten: 8,7 Mio. Brasilianer überschritten die Armutsgrenze (10.875/Tag). Brasilien von FAO-Hungerkarte gestrichen. Armutsrate auf 1,7 % gesunken.`,
    status: 'adopted',
    author: 'historical',
    date: '2003-10-20',
    impactStatement: 'Reference for conditional cash transfers worldwide; 20 years of evidence, replicated in 80+ countries.',
    populationAffected: '20.4 million Brazilian families (≈50M people)',
    estimatedCost: 'R$168B/year (≈$34B); 1.7% Brazilian GDP',
    sources: [
      { label: 'World Bank — Twenty Years of Bolsa Família', year: 2023 },
      { label: 'FAO — The State of Food Security in Latin America 2023', year: 2023 },
      { label: 'Brazil Reports — Bolsa Família Lifted 3 Million Out of Poverty in 2023', year: 2023 },
      { label: 'IPES-Food — Brazil Beats Hunger', year: 2024 },
    ],
    tags: ['Bolsa Família', 'conditional cash transfer', 'Brazil', 'poverty', 'hunger', 'Lula', 'CCT', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2003–2024 (interruption 2019–2022)',
      country_context: 'Brésil, 215M habitants, PIB $2.1T, forte inégalité (Gini 0.53)',
      gdp_impact: 'Multiplicateur fiscal 1.78 (Osorio & Soares): chaque BRL transféré génère 1.78 BRL PIB local',
      employment_impact: 'Scolarisation enfants +6%; travail des enfants −14%; mobilité sociale ++',
      inequality_impact: 'Gini −0.023 attribué à Bolsa Família (2003-2010); mortalité infantile −17%',
      fiscal_impact: 'Coût 1.7% PIB; brésil retiré carte FAO faim 2023; 8.7M sortis pauvreté en 12 mois',
      key_finding: 'Le programme de transfert conditionnel le plus répliqué au monde : 20 ans de preuves montrent des impacts durables sur l\'éducation, la santé et la réduction de la pauvreté.',
      sources: ['World Bank 2023', 'FAO 2023', 'IPES-Food 2024'],
    },
  },

  {
    ...
    countryFlag: '🇩🇪',
    domain: 'environment',
    title: "Energiewende — Germany's Energy Transition 2010",
    titleFr: 'Energiewende — Transition énergétique allemande 2010',
    titleDe: 'Energiewende — Deutschlands Energiewende 2010',
    summary: "Germany's commitment to reach climate neutrality by 2045, phasing out nuclear power (2023) and coal (2038), while scaling renewables to 80% of electricity by 2030. Largest energy transition by a major industrial economy. By 2025: 55.3% renewable electricity; costs €737B grid investment needed by 2045.",
    summaryFr: "L'engagement de l'Allemagne à atteindre la neutralité climatique d'ici 2045, en sortant du nucléaire (2023) et du charbon (2038), tout en portant les renouvelables à 80 % de l'électricité d'ici 2030. La plus grande transition énergétique d'une grande économie industrielle. En 2025 : 55,3 % d'électricité renouvelable.",
    summaryDe: "Deutschlands Verpflichtung zur Klimaneutralität bis 2045, Ausstieg aus Kernkraft (2023) und Kohle (2038), Ausbau der Erneuerbaren auf 80 % des Stroms bis 2030. Größte Energiewende einer großen Industrienation. 2025: 55,3 % Erneuerbare im Strommix.",
    content: `Energiewende (literally 'energy turnaround') was formally embedded in law in 2010 under Chancellor Merkel. Key milestones: nuclear phase-out completed April 2023 (last three plants closed); coal phase-out target 2038 (accelerated to 2030 in some scenarios); renewable electricity target 80% by 2030.\n\nBy 2025: Renewables cover 55.3% of total electricity consumption. GHG emissions fell to 640Mt CO₂-eq (2024), down from 970Mt (1990). Jobs: 371,000+ created in renewable energy industry by 2013; ~100,000 lost in solar sector due to Chinese competition.\n\nCosts: End-user electricity prices among highest in Europe (€0.38/kWh residential 2024). Grid balancing costs: €36B/year. Total grid investment needed to 2045: €737B. Energy-intensive industrial production 17% below 2022 pre-crisis levels (2025). Some manufacturers have relocated to lower-energy-cost countries.\n\nThe Energiewende is simultaneously praised as a model for decarbonization and criticized for its cost burden on industry and households. The simultaneous nuclear exit and coal exit (post-Ukraine war gas crisis) was particularly controversial.\n\nSources: Agora Energiewende 2025 Annual Review; Clean Energy Wire; Bundesministerium für Wirtschaft und Klimaschutz.`,
    contentFr: `L'Energiewende (littéralement 'tournant énergétique') a été formalisée en loi en 2010 sous la chancelière Merkel. Jalons clés : sortie du nucléaire achevée en avril 2023 ; objectif de sortie du charbon 2038 ; cible 80 % d'électricité renouvelable d'ici 2030.\n\nEn 2025 : les renouvelables couvrent 55,3 % de la consommation électrique totale. Émissions de GES tombées à 640 Mt CO₂-éq. (2024), contre 970 Mt en 1990. Emplois : +371 000 créés dans les énergies renouvelables ; ~100 000 perdus dans le solaire face à la concurrence chinoise.\n\nCoûts : prix de l'électricité parmi les plus élevés d'Europe (0,38 €/kWh résidentiel 2024). Coûts d'équilibrage du réseau : 36 Mds€/an. Investissement réseau nécessaire d'ici 2045 : 737 Mds€. La production industrielle énergivore reste 17 % sous les niveaux de 2022.\n\nL'Energiewende est simultanément saluée comme modèle de décarbonation et critiquée pour son coût pour les industries et les ménages.`,
    contentDe: `Die Energiewende wurde 2010 unter Bundeskanzlerin Merkel gesetzlich verankert. Meilensteine: Kernenergieausstieg abgeschlossen April 2023; Kohleausstiegsziel 2038; 80 % erneuerbare Energie bis 2030.\n\n2025: Erneuerbare decken 55,3 % des Stromverbrauchs. THG-Emissionen auf 640 Mio. t CO₂-Äq. (2024) gesunken, gegenüber 970 Mio. t (1990). Arbeitsplätze: +371.000 in der Erneuerbare-Energien-Branche; ~100.000 verloren im Solarsektor durch chinesischen Wettbewerb.\n\nKosten: Haushaltsstrompreise zu den höchsten Europas (0,38 €/kWh 2024). Netzausgleichskosten: 36 Mrd. €/Jahr. Gesamtinvestitionsbedarf Stromnetz bis 2045: 737 Mrd. €. Energieintensive Industrie 17 % unter 2022-Niveau.\n\nDie Energiewende wird als Modell für Dekarbonisierung gelobt und wegen ihrer Kostenbelastung für Industrie und Haushalte kritisiert.`,
    status: 'adopted',
    author: 'historical',
    date: '2010-09-28',
    impactStatement: 'Global model for industrial economy decarbonization; 55.3% renewable electricity by 2025.',
    populationAffected: '84 million Germans; global model for 50+ countries',
    estimatedCost: '€737B grid investment by 2045; €36B/year balancing costs; €0.38/kWh consumer price',
    sources: [
      { label: 'Agora Energiewende — State of the Energy Transition in Germany: Annual Review 2025', year: 2025 },
      { label: 'Clean Energy Wire — Energiewende Effects on Power Prices, Costs and Industry', year: 2024 },
      { label: 'Bundesministerium für Wirtschaft — Erneuerbare Energien in Deutschland', year: 2025 },
    ],
    tags: ['Energiewende', 'Germany', 'energy transition', 'renewables', 'nuclear', 'coal', 'climate', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2010–2025',
      country_context: 'Allemagne, 84M hab., 4ème PIB mondial, grande industrie énergivore',
      gdp_impact: 'Production industrielle énergivore −17% vs 2022; certains délocalisations vers pays bas-énergie',
      employment_impact: '+371 000 emplois ENR créés; −100 000 solaire; pénurie techniciens ENR',
      inequality_impact: 'Prix électricité parmi les + élevés EU (0.38€/kWh); charge disproportionnée ménages modestes',
      fiscal_impact: '€737B d\'investissement réseau nécessaire d\'ici 2045; €36B/an coûts équilibrage',
      key_finding: "55.3% d'électricité renouvelable atteint — mais à un coût industriel et tarifaire élevé; sortie simultanée nucléaire+gaz+charbon controversée.",
      sources: ['Agora Energiewende 2025', 'Clean Energy Wire 2024'],
    },
  },

  {
    ...
    countryFlag: '🌍',
    domain: 'governance',
    title: 'GDPR — General Data Protection Regulation 2018',
    titleFr: 'RGPD — Règlement général sur la protection des données 2018',
    titleDe: 'DSGVO — Datenschutz-Grundverordnung 2018',
    summary: "The EU's comprehensive data protection framework (effective May 25, 2018) establishes user rights over personal data, mandatory breach notifications, data minimization, and fines up to 4% of global annual turnover. By 2024: €5.88B in total fines, 9 of 10 largest fines against US tech companies.",
    summaryFr: "Le cadre européen de protection des données (en vigueur le 25 mai 2018) établit des droits des utilisateurs sur leurs données personnelles, des notifications obligatoires de violation, la minimisation des données et des amendes allant jusqu'à 4 % du chiffre d'affaires annuel mondial. En 2024 : 5,88 Mds€ d'amendes totales, 9 des 10 plus grandes amendes contre des entreprises technologiques américaines.",
    summaryDe: 'Der umfassende EU-Datenschutzrahmen (ab 25. Mai 2018) legt Nutzerrechte an personenbezogenen Daten fest, schreibt Meldepflichten bei Datenschutzverletzungen vor und sieht Bußgelder bis zu 4 % des weltweiten Jahresumsatzes vor. Bis 2024: €5,88 Mrd. Gesamtbußgelder, 9 der 10 größten Bußgelder gegen US-Techunternehmen.',
    content: `The GDPR replaced the 1995 Data Protection Directive, establishing a single EU-wide framework applicable to any organization processing EU residents' data. Core rights: access, rectification, erasure ('right to be forgotten'), portability, restriction. Core obligations: lawful basis for processing, data minimization, privacy by design, mandatory 72-hour breach notification, Data Protection Officers.\n\nEnforcement timeline: First significant fine: Google (€50M, France CNIL, 2019). Amazon: €746M (Luxembourg, 2021) — then-largest ever. Meta: €1.2B (Ireland, 2023) — largest ever, for Facebook EU→US data transfers. LinkedIn: €310M (Ireland, 2024). Total: €5.88B since 2018 (2024 total: €1.2B, down 33% from 2023).\n\nBeyond fines: GDPR triggered global regulatory cascade — California CCPA (2020), Brazil LGPD (2020), India DPDPA (2023), Japan/South Korea updates. 'Brussels Effect': companies apply GDPR standards globally to simplify compliance. EU tech sector: some evidence of startup funding falling −27% in affected sectors post-GDPR (Janssen et al. 2022). US companies paid €1.15B/year avg in GDPR fines 2021-2024.\n\nSources: Infosecurity Magazine 2024; TechCrunch GDPR fines tracker; Janssen et al. (2022) 'GDPR and the Lost Generation of Innovative Apps' SSRN.`,
    contentFr: `Le RGPD a remplacé la directive sur la protection des données de 1995, établissant un cadre unique à l'échelle de l'UE applicable à toute organisation traitant des données de résidents européens. Droits fondamentaux : accès, rectification, effacement (« droit à l'oubli »), portabilité, limitation.\n\nChronologie des sanctions : Premier amende significative : Google (50 M€, CNIL France, 2019). Amazon : 746 M€ (Luxembourg, 2021). Meta : 1,2 Md€ (Irlande, 2023) — la plus grande amende jamais imposée. LinkedIn : 310 M€ (Irlande, 2024). Total : 5,88 Mds€ depuis 2018.\n\nAu-delà des amendes : Le RGPD a déclenché une cascade réglementaire mondiale — CCPA Californie (2020), LGPD Brésil (2020), DPDPA Inde (2023). Les entreprises américaines ont payé en moyenne 1,15 Md€/an en amendes RGPD (2021-2024). Certaines preuves suggèrent une baisse de −27 % du financement des startups dans les secteurs affectés (Janssen et al. 2022).`,
    contentDe: `Die DSGVO ersetzte die Datenschutzrichtlinie von 1995 und schuf einen einheitlichen EU-weiten Rahmen. Kerrechte: Auskunft, Berichtigung, Löschung ('Recht auf Vergessenwerden'), Portabilität. Kernpflichten: Rechtmäßige Verarbeitung, Datensparsamkeit, Privacy by Design, 72-Stunden-Meldepflicht.\n\nBußgeldverlauf: Google €50 Mio. (Frankreich CNIL, 2019). Amazon €746 Mio. (Luxemburg, 2021). Meta €1,2 Mrd. (Irland, 2023) — höchstes Bußgeld aller Zeiten. LinkedIn €310 Mio. (Irland, 2024). Gesamt: €5,88 Mrd. seit 2018.\n\nDarüber hinaus: DSGVO löste weltweite Regulierungskaskade aus — CCPA Kalifornien (2020), LGPD Brasilien (2020), DPDPA Indien (2023). 'Brussels Effect': Unternehmen wenden DSGVO-Standards global an. US-Unternehmen zahlten 2021–2024 im Schnitt €1,15 Mrd./Jahr an DSGVO-Bußgeldern.`,
    status: 'adopted',
    author: 'historical',
    date: '2018-05-25',
    impactStatement: 'Global data protection standard; triggered regulatory cascade in 100+ countries.',
    populationAffected: '450M EU residents; any company worldwide processing EU data',
    estimatedCost: '€5.88B in fines (2018–2024); compliance costs: €1.3B/year for large companies',
    sources: [
      { label: 'Infosecurity Magazine — GDPR Fines Total €1.2bn in 2024', year: 2024 },
      { label: 'TechCrunch — The 10 Largest GDPR Fines on Big Tech', year: 2024 },
      { label: 'Janssen et al. — The GDPR and the Lost Generation of Innovative Apps, SSRN', year: 2022 },
    ],
    tags: ['GDPR', 'RGPD', 'data protection', 'privacy', 'EU', 'tech regulation', 'fines', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2018–2024',
      country_context: 'UE, 450M résidents, toute entreprise mondiale traitant données UE',
      gdp_impact: 'Effet Brussels : conformité RGPD adoptée mondialement; coûts compliance $1.3B/an grandes entreprises',
      employment_impact: 'Startups affectées : financement −27% secteurs concernés (Janssen 2022); DPO: 500 000+ nouveaux emplois EU',
      inequality_impact: 'PME disproportionnément chargées vs BigTech; 9/10 plus grandes amendes = GAFAM',
      fiscal_impact: '€5.88B amendes collectées 2018-2024; €1.2B en 2024 seul; recettes DPA redistribuées États membres',
      key_finding: 'Premier standard mondial de protection des données; déclencheur d\'une cascade réglementaire sur 5 continents; fardeau de conformité asymétrique PME vs BigTech.',
      sources: ['Infosecurity Magazine 2024', 'TechCrunch 2024', 'Janssen 2022'],
    },
  },

  {
    id: 'SOC-GLOBAL-HIST-004',
    country: 'Global',
    countryFlag: '🌍',
    domain: 'social',
    title: 'China Targeted Poverty Alleviation — 800M Lifted 2013–2021',
    titleFr: 'Chine — Réduction ciblée de la pauvreté — 800M sortis de la pauvreté 2013–2021',
    titleDe: 'China — Gezielte Armutsbekämpfung — 800 Mio. aus Armut gehoben 2013–2021',
    summary: "Under Xi Jinping's 'Targeted Poverty Alleviation' (2013–2021), China lifted 98.99 million people out of absolute poverty, eliminated all 832 poverty-stricken counties, and deployed 3 million Party officials in villages. 75% of global poverty reduction 1981–2020 attributed to China.",
    summaryFr: "Dans le cadre de la « réduction ciblée de la pauvreté » de Xi Jinping (2013-2021), la Chine a sorti 98,99 millions de personnes de la pauvreté absolue, éliminé 832 comtés pauvres et déployé 3 millions de fonctionnaires du Parti dans les villages. 75 % de la réduction mondiale de la pauvreté (1981-2020) attribuée à la Chine.",
    summaryDe: "Im Rahmen von Xi Jinpings 'Gezielter Armutsbekämpfung' (2013–2021) hob China 98,99 Mio. Menschen aus absoluter Armut, eliminierte 832 arme Landkreise und entsandte 3 Mio. Parteikader in Dörfer. 75 % der globalen Armutsreduzierung 1981–2020 wird China zugeschrieben.",
    content: `China's poverty alleviation strategy combined: (1) Targeted identification — a national registry of 128,000 poor villages with household-level data; (2) Tailored interventions — relocation to new towns, industry development, ecological conservation employment, education, social security; (3) Massive bureaucratic mobilization — 3 million Party secretaries and team members dispatched to villages; (4) Accountability — provincial governors held personally responsible for meeting county-level targets.\n\nScale: From 2012 to 2021, China lifted an average of 10 million people/year out of poverty — equivalent to the population of Portugal every year. By December 2020, all 98.99 million impoverished rural residents had crossed the absolute poverty line ($1.90/day 2011 PPP).\n\nWorld Bank (2022): China accounts for 75% of global poverty reduction (1981-2020), lifting over 800 million people in 40 years. However, critics note: (1) threshold set low ($1.90/day does not reflect Chinese living standards); (2) top-down approach creates dependency; (3) quality of jobs and sustainability post-2021 unclear; (4) some relocation programs disrupted traditional livelihoods.\n\nPost-2021: 5-year transition period established to prevent relapse into poverty.`,
    contentFr: `La stratégie chinoise de lutte contre la pauvreté combine : (1) Identification ciblée — registre national de 128 000 villages pauvres avec données par ménage ; (2) Interventions sur mesure — délocalisation vers de nouvelles villes, développement industriel, emplois de conservation écologique, éducation, protection sociale ; (3) Mobilisation bureaucratique massive — 3 millions de secrétaires de Parti déployés dans les villages ; (4) Responsabilisation — gouverneurs provinciaux tenus personnellement responsables.\n\nÉchelle : de 2012 à 2021, la Chine a sorti en moyenne 10 millions de personnes/an de la pauvreté. D'ici décembre 2020, les 98,99 millions de résidents ruraux pauvres avaient tous franchi le seuil de pauvreté absolue (1,90 $/jour PPA 2011).\n\nBanque mondiale (2022) : la Chine représente 75 % de la réduction mondiale de la pauvreté (1981-2020), sortant plus de 800 millions de personnes en 40 ans. Les critiques notent : seuil bas (1,90 $/jour ne reflète pas les conditions de vie chinoises), approche verticale créant des dépendances, durabilité post-2021 incertaine.`,
    contentDe: `Chinas Armutsbekämpfungsstrategie kombiniert: (1) Gezielte Identifizierung — nationales Register von 128.000 armen Dörfern; (2) Maßgeschneiderte Maßnahmen — Umsiedlung, Industrieentwicklung, ökologische Beschäftigung, Bildung; (3) Massive Bürokratisierung — 3 Mio. Parteikader in Dörfer entsandt; (4) Rechenschaftspflicht — Provinzgouverneure persönlich verantwortlich.\n\nSkala: 2012–2021 wurden durchschnittlich 10 Mio. Menschen/Jahr aus der Armut gehoben. Bis Dezember 2020 hatten alle 98,99 Mio. armen Landbewohner die absolute Armutsgrenze überschritten.\n\nWeltbank (2022): China trägt 75 % zur globalen Armutsreduzierung (1981–2020) bei. Kritiker verweisen auf niedrige Schwelle ($1,90/Tag), Top-down-Ansatz, unklare Nachhaltigkeit post-2021.`,
    status: 'adopted',
    author: 'historical',
    date: '2013-11-22',
    impactStatement: 'Largest poverty reduction in human history: 800M people over 40 years; 75% of global total.',
    populationAffected: '800 million people (1981–2020); 98.99 million in final 2013–2021 phase',
    estimatedCost: '~$246B invested in poverty alleviation (2012–2020); 3 million officials deployed',
    sources: [
      { label: 'World Bank — Lifting 800 Million People Out of Poverty: Lessons from China', year: 2022 },
      { label: 'AMRO Asia — An Exemplary Journey in Eradicating Poverty', year: 2022 },
      { label: 'Government of China — White Paper on Poverty Alleviation', year: 2021 },
    ],
    tags: ['poverty', 'China', 'Xi Jinping', 'targeted poverty alleviation', 'social policy', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2013–2021 (phase finale; programme global 1981–2020)',
      country_context: 'Chine, 1.4Md hab., PIB $17T, transition économique rapide',
      gdp_impact: 'Croissance PIB +6-7%/an pendant la période; infrastructures rurales ++',
      employment_impact: '10M personnes/an sorties de pauvreté; 3M fonctionnaires déployés en zones rurales',
      inequality_impact: 'Gini chinois élevé (0.47): réduction pauvreté absolue mais inégalités persistantes',
      fiscal_impact: '$246B investis (2012-2020); efficience par rapport aux transferts directs débattue',
      key_finding: "La plus grande réduction de pauvreté de l'histoire humaine en valeur absolue — débat sur la durabilité, le seuil retenu et la comparabilité méthodologique avec les standards internationaux.",
      sources: ['World Bank 2022', 'AMRO Asia 2022'],
    },
  },

  {
    id: 'ENV-GLOBAL-HIST-001',
    country: 'Global',
    countryFlag: '🌍',
    domain: 'environment',
    title: 'Amazon Deforestation Under Bolsonaro 2019–2022',
    titleFr: "Déforestation de l'Amazonie sous Bolsonaro 2019–2022",
    titleDe: 'Amazonas-Abholzung unter Bolsonaro 2019–2022',
    summary: "Brazil's President Bolsonaro (2019–2022) systematically dismantled environmental enforcement: budgets slashed, inspectors fired, Indigenous land protections removed. Result: 59.5% surge in Amazon deforestation — highest in a Brazilian presidential term since satellite measurement began (1988). 8.4M acres deforested in first 3 years alone.",
    summaryFr: "Le président brésilien Bolsonaro (2019-2022) a systématiquement démantelé les mécanismes de protection de l'environnement : budgets réduits, inspecteurs licenciés, protections des terres autochtones supprimées. Résultat : hausse de 59,5 % de la déforestation amazonienne — la plus forte lors d'un mandat présidentiel brésilien depuis 1988.",
    summaryDe: 'Brasiliens Präsident Bolsonaro (2019–2022) demontierte systematisch den Umweltschutz: Budget gekürzt, Inspektoren entlassen, Schutz indigener Gebiete abgebaut. Ergebnis: 59,5 % Anstieg der Amazonas-Abholzung — höchste in einer brasilianischen Amtszeit seit Messbeginn (1988). 8,4 Mio. Acres in den ersten 3 Jahren allein gerodet.',
    content: `Under Bolsonaro, environmental policy was systematically reversed: IBAMA (environmental agency) budget cut 24%; Fundação Nacional dos Índios (FUNAI, Indigenous affairs) gutted; a proposed bill to legalize mining on Indigenous lands. Enforcement: 98% of deforestation alerts went uninvestigated.\n\nDeforestation statistics (INPE satellite data): 2019: 10,129 km² (highest since 2008). 2020: 11,088 km² (highest in 12 years). 2021: 13,038 km² (highest since 2006). 2022: 11,594 km² (−11% but still 59.5% above pre-Bolsonaro average). Total 2019-2022: 43,000 km² deforested — area larger than Switzerland.\n\nScientific impact: Some parts of the Amazon now emit more CO₂ than they absorb (Gatti et al. 2021, Nature). Scientists warn of tipping point at 20-25% deforestation (currently ~18-20%).\n\nUnder Lula (2023+): IBAMA budget restored, monitoring reinstituted. 2023 deforestation fell 50% vs 2022. August 2023: lowest Amazon deforestation rate in 14 years for that month.`,
    contentFr: `Sous Bolsonaro, la politique environnementale a été systématiquement inversée : budget de l'IBAMA (agence environnementale) réduit de 24 % ; FUNAI (affaires autochtones) désossée ; un projet de loi proposant de légaliser l'exploitation minière sur les terres autochtones. Contrôle : 98 % des alertes de déforestation n'ont pas été enquêtées.\n\nStatistiques de déforestation (données satellitaires INPE) : 2019 : 10 129 km² ; 2020 : 11 088 km² ; 2021 : 13 038 km² (plus haut depuis 2006) ; 2022 : 11 594 km² (−11 % mais toujours 59,5 % au-dessus de la moyenne pré-Bolsonaro). Total 2019-2022 : 43 000 km² — superficie supérieure à la Suisse.\n\nImpact scientifique : certaines parties de l'Amazonie émettent désormais plus de CO₂ qu'elles n'en absorbent (Gatti et al. 2021, Nature). Sous Lula (2023+) : budget IBAMA restauré ; déforestation 2023 en baisse de 50 % vs 2022.`,
    contentDe: `Unter Bolsonaro wurde die Umweltpolitik systematisch rückgängig gemacht: IBAMA-Budget um 24 % gekürzt; FUNAI (Indigenenangelegenheiten) ausgehöhlt; Gesetzentwurf zum Bergbau auf indigenen Gebieten vorgeschlagen. Durchsetzung: 98 % der Abholzungswarnungen wurden nicht untersucht.\n\nAbholzungsstatistik (INPE-Satellitendaten): 2019: 10.129 km²; 2020: 11.088 km²; 2021: 13.038 km²; 2022: 11.594 km² (59,5 % über vorbolsonaristischem Durchschnitt). Gesamt 2019–2022: 43.000 km² — größer als die Schweiz.\n\nWissenschaftliche Folgen: Teile Amazoniens emittieren mehr CO₂ als sie aufnehmen (Gatti 2021, Nature). Unter Lula (2023+): IBAMA-Budget wiederhergestellt; Abholzung 2023 um 50 % gegenüber 2022 gesunken.`,
    status: 'adopted',
    author: 'historical',
    date: '2019-01-01',
    impactStatement: '43,000 km² deforested 2019–2022; Amazon sections now net CO₂ emitters; 98% of alerts uninvestigated.',
    populationAffected: 'Amazon basin: 34M inhabitants; global climate impact',
    estimatedCost: 'Estimated $150B in ecosystem services destroyed; carbon stored released',
    sources: [
      { label: "Mongabay — 4 Years of Amazon Destruction: Bolsonaro's Legacy", year: 2023 },
      { label: 'Gatti et al. — Amazonia as a Carbon Source Linked to Deforestation, Nature', year: 2021 },
      { label: 'Human Rights Watch — Crisis in the Brazilian Amazon', year: 2022 },
      { label: 'Greenpeace — 4 Years of Amazon Destruction Report', year: 2022 },
    ],
    tags: ['Amazon', 'deforestation', 'Bolsonaro', 'Brazil', 'climate', 'environment', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2019–2022',
      country_context: 'Brésil, Amazonie 6.7M km², 34M habitants riverains, poumon climatique mondial',
      gdp_impact: 'Agrobusiness brésilien court terme ++; perte services écosystémiques $150B estimé',
      employment_impact: 'Emplois miniers et agricoles illegaux ++; communautés autochtones --',
      inequality_impact: 'Droits autochtones systématiquement violés; peuples forestiers déplacés',
      fiscal_impact: '98% alertes non enquêtées; budget IBAMA −24%; impunité quasi-totale',
      key_finding: "+59.5% de déforestation en 4 ans; certaines zones Amazoniennes devenues émettrices nettes de CO₂ — démonstration qu'un désengagement réglementaire délibéré peut inverser des décennies de protection environnementale en quelques années.",
      sources: ['Mongabay 2023', 'Gatti et al. Nature 2021', 'Greenpeace 2022'],
    },
  },

  {
    ...
    countryFlag: '🌍',
    domain: 'economy',
    title: 'European Austerity — Greek Crisis & IMF Troika 2010',
    titleFr: 'Austérité européenne — Crise grecque et Troïka FMI 2010',
    titleDe: 'Europäische Austerität — Griechenlandkrise und IWF-Troika 2010',
    summary: 'Greece received three international bailouts (2010, 2012, 2015) totaling €289B from the IMF/ECB/ESM Troika, in exchange for the deepest peacetime fiscal adjustment in OECD history. GDP fell 25% peak-to-trough; unemployment reached 27.9% (youth: 62%). Most controversial macroeconomic experiment of the 2010s.',
    summaryFr: "La Grèce a reçu trois renflouements internationaux (2010, 2012, 2015) totalisant 289 Mds€ de la Troïka FMI/BCE/MES, en échange de l'ajustement budgétaire en temps de paix le plus profond de l'histoire de l'OCDE. Le PIB a chuté de 25 % au total ; le chômage a atteint 27,9 % (jeunes : 62 %).",
    summaryDe: 'Griechenland erhielt drei internationale Rettungspakete (2010, 2012, 2015) in Höhe von insgesamt €289 Mrd. von der IWF/EZB/ESM-Troika, im Gegenzug für die tiefste friedenszeitliche Haushaltsanpassung in der OECD-Geschichte. Das BIP fiel um 25 %; die Arbeitslosigkeit erreichte 27,9 % (Jugendarbeitslosigkeit: 62 %).',
    content: `The Greek debt crisis (2010–2015) was triggered by revelation that Greek debt had been systematically understated. The Troika (IMF, ECB, European Commission) imposed three Memoranda of Understanding requiring: pension cuts (nominal −20% to −45%), wages cuts (public sector −20%), VAT increases, privatizations, labor market deregulation.\n\nMacroeconomic outcomes: Greek GDP fell 25% from peak (2008) to trough (2013) — the largest peacetime contraction of a developed economy since the Great Depression. Unemployment rose from 7.5% (2008) to 27.9% (2013); youth unemployment peaked at 62.3%. Public debt/GDP: paradoxically rose from 103% to 177% despite austerity (because denominator fell faster).\n\nHealth impacts (documented): Unmet medical need doubled among poorest quintile (7%→14%). HIV infections +52% (2012 vs 2011). Suicide rate +35% (2010-2012). Mental health crisis documented across multiple studies.\n\nIMF self-criticism: In 2013, IMF Chief Economist Olivier Blanchard and David Leigh published 'Growth Forecast Errors and Fiscal Multipliers' acknowledging the multiplier had been underestimated — spending cuts had 2× greater negative impact than modeled. A 2013 IMF report acknowledged 'notable failures' in the first Greek program.\n\nGreece returned to growth in 2017; by 2023, GDP per capita had not yet recovered to 2008 levels.`,
    contentFr: `La crise de la dette grecque (2010-2015) a été déclenchée par la révélation que la dette grecque avait été systématiquement sous-évaluée. La Troïka (FMI, BCE, Commission européenne) a imposé trois mémorandums exigeant : réductions des retraites (−20 % à −45 % nominaux), baisses de salaires dans le secteur public (−20 %), hausses de TVA, privatisations, dérégulation du marché du travail.\n\nRésultats macroéconomiques : le PIB grec a chuté de 25 % du pic (2008) au creux (2013) — la plus grande contraction en temps de paix d'une économie développée depuis la Grande Dépression. Le chômage est passé de 7,5 % (2008) à 27,9 % (2013) ; le chômage des jeunes a atteint 62,3 %.\n\nImpacts sur la santé : les besoins médicaux non satisfaits ont doublé chez le quintile le plus pauvre (7 %→14 %). Infections VIH +52 % (2012 vs 2011). Taux de suicide +35 % (2010-2012).\n\nAutoévaluation du FMI (2013) : Blanchard et Leigh ont reconnu que le multiplicateur avait été sous-estimé — les coupes budgétaires avaient eu un impact négatif 2× supérieur à ce qui avait été modélisé. La Grèce est retournée à la croissance en 2017 ; d'ici 2023, le PIB par habitant n'avait pas encore retrouvé son niveau de 2008.`,
    contentDe: `Die griechische Schuldenkrise (2010–2015) wurde durch die Enthüllung ausgelöst, dass die griechischen Schulden systematisch unterschätzt worden waren. Die Troika (IWF, EZB, Europäische Kommission) verhängte drei Memoranda, die Folgendes forderten: Rentenkürzungen (−20 % bis −45 %), öffentliche Lohnkürzungen (−20 %), Mehrwertsteuererhöhungen, Privatisierungen.\n\nMakroökonomische Ergebnisse: Griechisches BIP fiel 25 % vom Höchst- (2008) zum Tiefststand (2013) — größter friedenszeitlicher Einbruch einer Industriewirtschaft seit der Großen Depression. Arbeitslosigkeit stieg von 7,5 % auf 27,9 %; Jugendarbeitslosigkeit auf 62,3 %.\n\nIWF-Selbstkritik (2013): Blanchard und Leigh räumten ein, dass der Fiskalmultiplikator unterschätzt worden war — Ausgabenkürzungen hatten 2× stärkere negative Wirkung als modelliert. Griechenland kehrte 2017 zum Wachstum zurück; bis 2023 hatte das BIP pro Kopf das Niveau von 2008 noch nicht wiedererreicht.`,
    status: 'adopted',
    author: 'historical',
    date: '2010-05-02',
    impactStatement: 'GDP −25%; unemployment 27.9%; youth unemployment 62%; most studied austerity case in modern economics.',
    populationAffected: '11 million Greeks; model applied to Spain, Portugal, Ireland, Cyprus',
    estimatedCost: 'GDP loss ~€50B; 3 bailouts totaling €289B; human cost: documented health crisis',
    sources: [
      { label: 'Blanchard & Leigh — Growth Forecast Errors and Fiscal Multipliers, IMF WP/13/1', year: 2013 },
      { label: 'Oxfam — A Cautionary Tale: The True Cost of Austerity and Inequality in Europe', year: 2013 },
      { label: 'Austerity and Health: The Impact in the UK and Europe, European Journal of Public Health', year: 2017 },
      { label: 'CEPR VoxEU — Austerity in the Aftermath of the Great Recession', year: 2019 },
    ],
    tags: ['austerity', 'Greece', 'IMF', 'Troika', 'debt crisis', 'eurozone', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2010–2017 (récession); PIB 2023 encore <2008',
      country_context: 'Grèce, 11M hab., PIB €180B, dette/PIB 177% au pic',
      gdp_impact: 'PIB −25% pic-à-creux (2008-2013); plus forte contraction temps de paix OCDE depuis 1930s',
      employment_impact: 'Chômage 7.5%→27.9% (2013); jeunes 62.3%; 400 000 Grecs qualifiés émigrés',
      inequality_impact: 'Besoins médicaux non couverts ×2 quintile inférieur; suicides +35%; VIH +52%',
      fiscal_impact: 'Multiplicateur sous-estimé (IMF 2013: ×2 vs modèle); dette/PIB 103%→177% malgré coupes',
      key_finding: "L'expérience d'austérité la plus documentée et controversée des années 2010: contraction économique sous-estimée, coûts sociaux sévères, et dette augmentant malgré les coupes — le FMI a reconnu ses erreurs de modélisation.",
      sources: ['Blanchard & Leigh IMF 2013', 'CEPR VoxEU 2019', 'Oxfam 2013'],
    },
  },

  {
    id: 'GOV-GLOBAL-HIST-002',
    country: 'Global',
    countryFlag: '🌍',
    domain: 'governance',
    title: 'New Zealand Wellbeing Budget — Jacinda Ardern 2019',
    titleFr: 'Budget bien-être de Nouvelle-Zélande — Jacinda Ardern 2019',
    titleDe: 'Neuseelands Wohlbefindens-Budget — Jacinda Ardern 2019',
    summary: "World's first national budget explicitly organized around wellbeing outcomes rather than GDP growth. NZ$1.9B invested in mental health (largest single investment in NZ history), child poverty reduction, and Māori/Pasifika aspirations. 5 years on: child poverty actually increased; mental health services still inaccessible to young people.",
    summaryFr: "Premier budget national au monde explicitement organisé autour d'indicateurs de bien-être plutôt que de croissance du PIB. NZ 1,9 Md$ investis dans la santé mentale (plus grand investissement unique de l'histoire de la NZ), la réduction de la pauvreté des enfants et les aspirations maories/pasifika. 5 ans après : la pauvreté infantile a augmenté ; les services de santé mentale restent inaccessibles.",
    summaryDe: 'Weltweit erstes nationales Budget, das explizit nach Wohlbefindensergebnissen statt nach BIP-Wachstum strukturiert ist. NZ$ 1,9 Mrd. in psychische Gesundheit investiert. 5 Jahre später: Kinderarmut gestiegen, Dienste für psychische Gesundheit für Jugendliche weiterhin unzugänglich.',
    content: `New Zealand's 2019 Wellbeing Budget, presented by Finance Minister Grant Robertson and championed by PM Jacinda Ardern, was the world's first budget structured around five wellbeing priorities: mental health, child wellbeing, Māori/Pasifika aspirations, productive economy, and low emissions. All budget decisions required agencies to show alignment with wellbeing goals.\n\nKey investment: NZ$1.9B for mental health services — the single largest investment in NZ history in that area. Funded: 1,700 new mental health workers; specialist services; primary mental health programs. Child poverty: NZ$320M for housing, food support, school donations scheme. First country to legislate child poverty measures alongside each budget (Child Poverty Reduction Act 2018).\n\nResults (2024 assessment): Five years on, Newsroom NZ reported 'it was hard to figure out what had really changed.' Child poverty (material hardship rate) rose from 11.3% to 12.5% (year to June 2023) — 2pp increase. Despite NZ$1.9B spend on mental health, young people still cannot access services (Auditor-General report 2023). The framework was formally abandoned by the incoming National government in 2024 ('Wellbeing Budget is dead').\n\nInternational influence: NZ inspired the OECD Wellbeing Framework, Scotland's Economy, Iceland's wellbeing agenda. The concept proved more influential internationally than domestically.`,
    contentFr: `Le budget bien-être néo-zélandais de 2019, présenté par le ministre des Finances Grant Robertson et soutenu par la PM Jacinda Ardern, était le premier budget au monde structuré autour de cinq priorités de bien-être. Toutes les décisions budgétaires exigeaient que les agences montrent leur alignement avec les objectifs de bien-être.\n\nInvestissement clé : NZ 1,9 Md$ pour les services de santé mentale — le plus grand investissement unique de l'histoire néo-zélandaise dans ce domaine. Financés : 1 700 nouveaux travailleurs en santé mentale ; services spécialisés. Pauvreté infantile : NZ 320 M$.\n\nRésultats (bilan 2024) : Cinq ans après, la pauvreté infantile (taux de privation matérielle) a augmenté de 11,3 % à 12,5 % (exercice à juin 2023). Malgré NZ 1,9 Md$ dépensés en santé mentale, les jeunes ne peuvent toujours pas accéder aux services (rapport du Contrôleur général 2023). Le cadre a été formellement abandonné par le gouvernement National entrant en 2024.\n\nInfluence internationale : la NZ a inspiré le cadre de bien-être de l'OCDE, l'agenda bien-être de l'Écosse et de l'Islande — le concept s'est révélé plus influent à l'international qu'à l'intérieur du pays.`,
    contentDe: `Neuseelands Wohlbefindens-Budget 2019, präsentiert von Finanzminister Grant Robertson und von PM Jacinda Ardern vorangetrieben, war das weltweit erste Budget, das um fünf Wohlbefindensprioritäten strukturiert wurde. Alle Haushaltsentscheidungen mussten Ausrichtung auf Wohlbefindensziele nachweisen.\n\nKerninvestition: NZ$ 1,9 Mrd. für psychische Gesundheitsleistungen. Finanziert: 1.700 neue Fachkräfte; Spezialdienste. Kinderarmut: NZ$ 320 Mio.\n\nErgebnisse (Bewertung 2024): Fünf Jahre später stieg die Kinderarmut von 11,3 % auf 12,5 %. Trotz NZ$ 1,9 Mrd. für psychische Gesundheit können Jugendliche weiterhin keine Leistungen abrufen (Rechnungshof 2023). Das Rahmenwerk wurde 2024 von der neuen Nationalregierung formell aufgegeben.\n\nInternationale Wirkung: Neuseeland inspirierte den OECD-Wohlbefindensrahmen, Schottlands und Islands Wohlbefindenspolitik — das Konzept erwies sich international als einflussreicher als im Inland.`,
    status: 'adopted',
    author: 'historical',
    date: '2019-05-30',
    impactStatement: 'Global model for wellbeing economics; mixed domestic results; abandoned by successor government in 2024.',
    populationAffected: '5 million New Zealanders; global policy influence',
    estimatedCost: 'NZ$1.9B mental health; NZ$320M child poverty; total budget NZ$91B',
    sources: [
      { label: 'NZ Treasury — The Wellbeing Budget 2019', year: 2019 },
      { label: 'Newsroom NZ — The Wellbeing Budget Is Dead', year: 2024 },
      { label: 'NZ Auditor-General — Mental Health: State of Public Services', year: 2023 },
      { label: 'IMF — New Zealand: Changing the Conversation on Well-Being', year: 2022 },
    ],
    tags: ['wellbeing', 'New Zealand', 'Ardern', 'mental health', 'child poverty', 'budget', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2019–2024',
      country_context: 'Nouvelle-Zélande, 5M hab., PIB $250B, référence mondiale en politique publique',
      gdp_impact: 'Croissance NZ nominale maintenue; pas d\'impact mesurable du cadre lui-même',
      employment_impact: '+1700 travailleurs santé mentale créés; effets sur emploi global non isolés',
      inequality_impact: 'Pauvreté infantile +2pp (11.3→12.5%); accès santé mentale jeunes: toujours insuffisant',
      fiscal_impact: 'NZ$1.9B santé mentale; résultats d\'accessibilité décevants (rapport Contrôleur général 2023)',
      key_finding: "Première expérience mondiale de budget bien-être : très influente à l'international, décevante à l'intérieur — démontre l'écart entre cadres conceptuels innovants et résultats opérationnels mesurables.",
      sources: ['NZ Treasury 2019', 'Newsroom NZ 2024', 'NZ Auditor-General 2023'],
    },
  },

  {
    ...
    countryFlag: '🌍',
    domain: 'environment',
    title: "EU Emissions Trading System — World's Largest Carbon Market 2005",
    titleFr: 'SEQE-UE — Plus grand marché carbone mondial 2005',
    titleDe: 'EU-ETS — Weltgrößtes CO₂-Emissionshandelssystem 2005',
    summary: "The EU ETS, launched in 2005, is the world's largest carbon market covering 40% of EU GHG emissions (energy, industry, aviation). Price collapsed to €2–8 (2012–2018) before structural reform; reached €100/tonne (2023) after REPowerEU reform. Generated €102B in carbon revenues globally in 2024.",
    summaryFr: "Le SEQE-UE, lancé en 2005, est le plus grand marché carbone mondial couvrant 40 % des émissions de GES de l'UE (énergie, industrie, aviation). Le prix s'est effondré à 2-8 €/t (2012-2018) avant la réforme structurelle ; il a atteint 100 €/t (2023). Recettes mondiales de tarification carbone : 102 Mds$ en 2024.",
    summaryDe: 'Das EU-ETS, gestartet 2005, ist das weltgrößte CO₂-Marktinstrument und deckt 40 % der EU-THG-Emissionen ab. Preis kollabierte auf €2–8 (2012–2018) vor Strukturreform; erreichte €100/t (2023). Globale CO₂-Preiserlöse: $102 Mrd. in 2024.',
    content: `The EU ETS operates on a 'cap and trade' principle: a total cap on GHG emissions declines annually; companies must hold allowances (EUAs) for each tonne emitted, trading them in a market. Phase 1 (2005-2007): oversupply caused price collapse to near-zero. Phase 2 (2008-2012): price €10-30 but financial crisis collapsed demand. Phase 3 (2013-2020): backloading of allowances, Market Stability Reserve (2019) — prices recovered to €25. Phase 4 (2021-2030): REPowerEU + Fit for 55: linear reduction factor increased; price reached €98/t (Feb 2023); stabilized €65-80 (2024).\n\nCovered sectors: Power generation, heavy industry, aviation (intra-EU). From 2024: maritime shipping added. From 2027: separate ETS for buildings and road transport (ETS2).\n\nDocumented emissions reductions: ETS-covered sectors reduced emissions 43% since 2005 (Commission 2023). Aviation emissions: more complex (offset by growth in air travel). Revenues: €35B distributed to member states in 2023 alone; mandated 50% for climate investments. Innovation Fund: €38B for clean tech.\n\nCriticisms: Carbon Leakage (companies moving to non-ETS countries); windfall profits for energy companies (free allowances in early phases); regressive distributional impact (energy costs disproportionately hit low incomes). Solution: Carbon Border Adjustment Mechanism (CBAM) launched 2023.`,
    contentFr: `Le SEQE-UE fonctionne sur le principe du « plafonnement et échange » : un plafond total d'émissions de GES diminue annuellement ; les entreprises doivent détenir des quotas (EUA) pour chaque tonne émise, qu'elles échangent sur un marché.\n\nPhase 1 (2005-2007) : surabondance de quotas, prix effondré à quasi zéro. Phase 2 (2008-2012) : prix 10-30 € mais la crise financière a effondré la demande. Phase 3 (2013-2020) : réserve de stabilité du marché (2019) — prix remontés à 25 €. Phase 4 (2021-2030) : paquet REPowerEU + Fit for 55 : prix atteignant 98 €/t (fév. 2023) ; stabilisé 65-80 € (2024).\n\nRéductions d'émissions documentées : les secteurs couverts par le SEQE ont réduit leurs émissions de 43 % depuis 2005. Recettes 2023 : 35 Mds€ distribués aux États membres (50 % obligatoirement pour investissements climatiques). Fonds pour l'Innovation : 38 Mds€ pour les technologies propres.\n\nCritiques : risque de fuite de carbone ; profits d'aubaine pour les entreprises énergétiques ; impact régressif sur les ménages à faibles revenus. Solution : Mécanisme d'Ajustement Carbone aux Frontières (MACF/CBAM) lancé en 2023.`,
    contentDe: `Das EU-ETS funktioniert nach dem 'Cap and Trade'-Prinzip: Ein Gesamtdeckel an THG-Emissionen sinkt jährlich; Unternehmen müssen Zertifikate (EUAs) für jede emittierte Tonne halten.\n\nPhase 1 (2005–2007): Überangebot, Preiskollaps auf nahe null. Phase 2 (2008–2012): Preis €10–30, Finanzkrise drückte Nachfrage. Phase 3 (2013–2020): Marktstabilitätsreserve (2019) — Preise erholten sich auf €25. Phase 4 (2021–2030): REPowerEU + Fit for 55: Preis erreichte €98/t (Feb. 2023); stabilisiert €65–80 (2024).\n\nDokumentierte Emissionsreduktionen: ETS-abgedeckte Sektoren reduzierten Emissionen um 43 % seit 2005. Einnahmen 2023: €35 Mrd. an Mitgliedstaaten (50 % obligatorisch für Klimainvestitionen). Kritik: Verlagerungsrisiko; Windfall-Gewinne für Energieunternehmen; regressive Verteilungswirkung. Lösung: CO₂-Grenzausgleichsmechanismus (CBAM) 2023 gestartet.`,
    status: 'adopted',
    author: 'historical',
    date: '2005-01-01',
    impactStatement: 'Covered sectors reduced emissions 43% since 2005; €35B climate revenues in 2023 alone.',
    populationAffected: '450M EU residents; 11,000 industrial installations; 600 airlines',
    estimatedCost: 'Carbon price €65–80/tonne (2024); €35B annual revenues to member states',
    sources: [
      { label: 'World Bank — State and Trends of Carbon Pricing 2025', year: 2025 },
      { label: 'European Commission — EU ETS: Delivering on Its Climate Objectives 2023', year: 2023 },
      { label: 'CEPR VoxEU — Carbon Pricing and Inequality', year: 2024 },
      { label: 'OECD — Effective Carbon Rates 2025', year: 2025 },
    ],
    tags: ['EU ETS', 'carbon market', 'emissions trading', 'climate', 'EU', 'carbon pricing', 'historical'],
    historical: true,
    historicalOutcomes: {
      period: '2005–2024',
      country_context: 'UE, 450M hab., 11 000 installations industrielles, 600 compagnies aériennes',
      gdp_impact: 'Prix carbone €100/t : coût compétitivité industrie; CBAM pour protéger contre fuite carbone',
      employment_impact: 'Industries lourdes sous pression; 38 Mds€ Innovation Fund → emplois verts',
      inequality_impact: 'Impact régressif (énergie pèse plus sur ménages modestes); ETS2 2027 pour bâtiments/transport',
      fiscal_impact: '€35B recettes 2023; 43% réduction émissions secteurs couverts depuis 2005; €102B mondial 2024',
      key_finding: 'Le plus grand marché carbone mondial a prouvé son efficacité environnementale (−43% émissions) mais sa conception initiale défaillante (quotas gratuits, prix bas) a perdu 15 ans — réformé efficacement depuis 2021.',
      sources: ['World Bank Carbon Pricing 2025', 'European Commission ETS 2023', 'OECD ECR 2025'],
    },
  },
]
